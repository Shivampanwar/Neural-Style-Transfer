...
class CONFIG:
    ...
    VGG_MODEL = 'pretrained-model/imagenet-vgg-verydeep-19_1.mat'  # Pick the VGG 19-layer model by from the paper "Very Deep Convolutional Networks for Large-Scale Image Recognition".
